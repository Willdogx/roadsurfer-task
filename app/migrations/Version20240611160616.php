 ...
 */
final class Version20240611160616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, activity_type_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, distance DOUBLE PRECISION NOT NULL, distance_unit VARCHAR(255) NOT NULL, elapsed_time INT NOT NULL, activity_date DATETIME NOT NULL, INDEX IDX_AC74095AC51EFA73 (activity_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
